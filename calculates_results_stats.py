...
def calculates_results_stats(results_dic):
    ...
    """        
    # create empty dictionary for results stats dictionary 
    results_stats_dic= {}
    ...
    for key in  results_dic:
        ...
        if results_dic[key][3] == 1:
                ...
                if results_dic[key][4] == 0:
                         # calculates number of non dog classifications
